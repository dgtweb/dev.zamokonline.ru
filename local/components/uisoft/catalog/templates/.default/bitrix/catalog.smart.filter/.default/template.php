...
<div class="bx-filter">
    <div class="bx-filter-section">
        <?
        /*<div class="bx-filter-title"><?= GetMessage("CT_BCSF_FILTER_TITLE") ?>11</div>*/ ?>
        <?
        // Выбор раздела как отдельный блок
        //\ALS\Helper\Dbg::show($arResult, true, true);
        ?>
        <?
        if (!empty($arParams['STRUCTURE_SECTION']['items'])): ?>
            <div class="row">
                <div class="col-lg-12 bx-filter-parameters-box bx-active filter-sections">
                    <div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
                        <span class="bx-filter-parameters-box-hint"><?= $arParams['STRUCTURE_SECTION']['name'] ?></span>
                    </div>

                    <div class="bx-filter-block" data-role="bx_filter_block">
                        <div class="bx-filter-parameters-box-container row no-gutters">
                            <div class="col-12">
                                <?
                                foreach ($arParams['STRUCTURE_SECTION']['items'] as $item): ?>
                                    <a target="_self" href="<?= $item['url'] ?>"><?= $item['name'] ?></a>
                                <?
                                endforeach; ?>
                            </div>
                        </div>
        ...
        echo $arResult["FORM_ACTION"] ?>" method="get" class="smartfilter">
            <?
            ...
            <div class="row">
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem)//prices
                {
                    ...
                    if (isset($arItem["PRICE"])):
                        ...
                        if ($arParams["FILTER_VIEW_MODE"]
                            ...
                            <div class="bx-filter-block" data-role="bx_filter_block">
                                <div class="bx-filter-parameters-box-container row no-gutters">
                                    <div class="bx-filter-parameters-box-container-block bx-left col-6">
                                    ...
                                    <div class="bx-filter-parameters-box-container-block bx-right col-6">
                                    ...
                                    <div class="bx-ui-slider-track-container col-12">
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    ...
                    endif ?> bx-filter-parameters-box <?
                    if ($arItem["DISPLAY_EXPANDED"]
                        == "Y"
                    ): ?>bx-active<?
                    endif ?>">
                                ...
                                ?>
                                    <div class="col-12">
                                        <div class="radio">
                                            ...
                                            echo "all_" . $arCur["CONTROL_ID"] ?>">
												<span class="bx-filter-input-radio custom-control custom-radio">
													<input
                                                            type="radio"
                                                            value=""
                                                            name="<?
                                                    ...
                                                    />
													<span class="bx-filter-param-text custom-control-content"><?
                                        ...
                                        foreach ($arItem["VALUES"] as $val => $ar): ?>
                                            <div class="radio">
                                                <label data-role="label_<?= $ar["CONTROL_ID"] ?>" class="bx-filter-param-label" for="<?
                                                echo $ar["CONTROL_ID"] ?>">
													<span class="bx-filter-input-radio custom-control custom-radio <?
                ...
                <div class="col-12 bx-filter-button-box">
                    <div class="bx-filter-block">
                        <div class="bx-filter-parameters-box-container">
                            <div class="filter-buttons-row-mobile">
                                <input
                                        class="btn btn-themes btn-filter-set"
                                        type="submit"
                                        id="set_filter"
                                        name="set_filter"
                            ...
                            <input
                                    class="btn btn-link btn-filter-reset"
                                    type="submit"
                                    id="del_filter"
                                    name="del_filter"
                            ...
                            if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"] ?>" id="modef" <?
                            if (!isset($arResult["ELEMENT_COUNT"])) {
                                ...
                                echo GetMessage(
                                    ...
                                    array(
                                        "#ELEMENT_COUNT#" => '<span id="modef_num">' . intval($arResult["ELEMENT_COUNT"]) . '</span>'
                                    )
                                ); ?>
