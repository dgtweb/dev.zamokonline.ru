...
class Dbg {
     ...
     * @param bool $varDump - Добавляет var_dump
     */
    public static function showMax($arr, $die = false, $all = false, $varDump = false)
    {
        global $USER;
        ...
        if (method_exists(\Uisoft\App\ExDebug::class,'include')){
            \Uisoft\App\ExDebug::include(true);
        }
